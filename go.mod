...
replace (
	...
	github.com/moby/buildkit => github.com/alexcb/buildkit v0.0.0-20210728171748-7ae108d84c84
	github.com/tonistiigi/fsutil => github.com/alexcb/fsutil v0.0.0-20210609160335-a94814c540b2
)
